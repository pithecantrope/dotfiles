...
static const char *screenshot_active[] = { "sh", "-c", "maim -u $HOME/Downloads/$(date +%s).png", NULL };
static const char *screenshot_region[] = { "sh", "-c", "maim -u -s $HOME/Downloads/$(date +%s).png", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_s,      spawn,          {.v = screenshot_active} },

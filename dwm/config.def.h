...
static const char *fonts[]          = { "Cascadia Mono:style=Bold:size=18" };
static const char dmenufont[]       = "Cascadia Mono:style=Bold:size=18";
...
static const Rule rules[] = {
	...
	{  NULL,      "chromium",         NULL,      1 << 3,       0,           -1 },
	{  NULL,      "libreoffice",      NULL,      1 << 2,       0,           -1 },
	{  NULL,      "pinta",            NULL,      1 << 2,       0,           -1 },
};
